package vn.boidstudio.freshflower.volley.utils;
...
public class MyNetworkImage extends ImageView {
	...
	public MyNetworkImage(Context context) {
		this(context, null);
	}

	public MyNetworkImage(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MyNetworkImage(Context context, AttributeSet attrs, int defStyle) {
