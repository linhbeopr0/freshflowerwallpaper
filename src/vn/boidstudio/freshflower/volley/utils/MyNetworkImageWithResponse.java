...
public class MyNetworkImageWithResponse extends ImageView {
	...
	public MyNetworkImageWithResponse(Context context) {
		this(context, null);
	}

	public MyNetworkImageWithResponse(Context context, AttributeSet attrs) {
